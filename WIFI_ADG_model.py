...
#                                       "target2"))
    ...
    def load_model(self, sess, path, prefix="ATN_"):
        self._target1.load(sess, path+'/movement_new5')
        self._target2.load(sess, path+'/person_new5')
        self._target3.load(sess, path+'/location_new5')
...
#        self._autoencoder.save(sess, path+'/AE_CSI', name=prefix+'basic_ae.ckpt')
        self._target1.save(sess, path+'/movement_new5')
        self._target2.save(sess, path+'/person_new5')
        self._target3.save(sess, path+'/location_new5')
