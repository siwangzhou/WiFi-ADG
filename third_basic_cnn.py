...
class ThirdBasicCnn:
    ...
    def weights(self):
        _weights = {
            ...
            'W_fc2': ne.weight_variable([128, 6], name='W_fc2')
        }
        return _weights
    ...
    def biases(self):
        _biases = {
            ...
            'b_fc2': ne.bias_variable([6], name='b_fc2')
        }
        return _biases
    ...
    def load(self, sess, path, name='cnn_loc.ckpt'):
        """
    ...
    def save(self, sess, path, name='cnn_loc.ckpt'):
        """
