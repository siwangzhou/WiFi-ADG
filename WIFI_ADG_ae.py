...
class BasicAE:
    ...
    def weights(self):
        _weights = {
            ...
            'W_conv8': ne.weight_variable([3, 3, 48, 1], name='W_conv8'),
#            'W_conv9': ne.weight_variable([3, 3, 48, 1], name='W_conv9')
    ...
    def biases(self):
        _biases = {
            ...
            'b_conv8': ne.bias_variable([1], name='b_conv8'),
...
#            self.biases['b_conv8'])
        h_conv8= ne.conv2d(h_conv7, self.weights['W_conv8']) + self.biases['b_conv8']
       # h_conv9 = tf.nn.tanh(
...
#            self.biases['b_conv8'])
       ...
       # h_conv9 = tf.nn.tanh(
        #    ne.conv2d(h_conv8, self.weights['W_conv9']) +
         #   self.biases['b_conv9'])
        return tf.reshape(self.data+h_conv8, [-1, 1800])
