...
class FirstBasicCnn:
    ...
    def weights(self):
        _weights = {
            ...
            'W_fc2': ne.weight_variable([128, 7], name='W_fc2')
        }
        return _weights
    ...
    def biases(self):
        _biases = {
            ...
            'b_fc2': ne.bias_variable([7], name='b_fc2')
        }
        return _biases
    ...
    def load(self, sess, path, name='cnn_act.ckpt'):
        """
    ...
    def save(self, sess, path, name='cnn_act.ckpt'):
        """
